...
class Lebe_Widgets_Instagram extends WP_Widget
{
    function __construct()
    {
        $widget_ops = array(
            'description' => esc_html__('Show off your favorite Instagram photos', 'lebe')
        );
        ...
        parent::__construct('lebe_instagram', esc_html__('Lebe: Instagram', 'lebe'), $widget_ops, $control_ops);
    }
    ...
    function widget($args, $instance)
    {
        ...
        if (intval($id) === 0) {
            echo '<p>' . esc_html__('No user ID specified.', 'lebe') . '</p>';
        }
        ...
        $output = '<div class="lebe-instagram clear cols-' . esc_attr($columns) . '">';
    ...
    function form($instance)
    {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('limit')); ?>"><?php esc_html_e('Number of Photos:', 'lebe'); ?></label>
...
add_action('widgets_init', 'Lebe_Widgets_Instagram');
function Lebe_Widgets_Instagram()
{
    register_widget('Lebe_Widgets_Instagram');
}
