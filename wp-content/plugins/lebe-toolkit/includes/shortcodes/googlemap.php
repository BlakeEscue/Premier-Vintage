<?php
if ( ! class_exists( 'Lebe_Shortcode_Googlemap' ) ) {
	class Lebe_Shortcode_Googlemap extends Lebe_Shortcode {
		/**
		 * Shortcode name.
		 *
		 * @var  string
		...
		public function output_html( $atts, $content = null ) {
			$atts = function_exists( 'vc_map_get_attributes' ) ? vc_map_get_attributes( 'lebe_googlemap', $atts ) : $atts;
			// Extract shortcode parameters.
			extract( $atts );
			$css_class   = array( 'lebe-google-maps' );
			...
			return apply_filters( 'lebe_shortcode_googlemap', force_balance_tags( $html ), $atts, $content );
		}
	}
}