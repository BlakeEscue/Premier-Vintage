<?php
    if (!class_exists('Lebe_Shortcode_categorylist')) {
        class Lebe_Shortcode_categorylist extends Lebe_Shortcode
        {
            /**
             * Shortcode name.
             *
            ...
            {
                $atts = function_exists('vc_map_get_attributes') ? vc_map_get_attributes('lebe_categorylist', $atts) : $atts;
            ...
            public function output_html($atts, $content = null)
            {
                ...
                // Extract shortcode parameters.
                extract($atts);
                $css_class = array('lebe-categorylist');
                        ...
                        <div class="cat-content-inner">
                            ...
                            <?php if ($link['url']): ?>
                                <a class="link-cat" href="<?php echo esc_url($term_link) ?>" target="<?php echo esc_url($link['target']) ?>">
                                    <span class="icon-bag"></span> <?php esc_html_e('Shop Now','lebe');?>
                                </a>
                            <?php endif; ?>
                        </div>
                    </div>
                ...
                <?php
                $html = ob_get_clean();
                return apply_filters('lebe_shortcode_categorylist', force_balance_tags($html), $atts, $content);
            }
        }
    }