...
if ( ! class_exists( 'Lebe_Shortcode_Dealproduct' ) ) {
	class Lebe_Shortcode_Dealproduct extends Lebe_Shortcode {
		/**
		 * Shortcode name.
		 *
		 * @var  string
		...
		public function output_html( $atts, $content = null ) {
			$atts = function_exists( 'vc_map_get_attributes' ) ? vc_map_get_attributes( 'lebe_dealproduct', $atts ) : $atts;
			
			extract( $atts );
			$css_class   = array( 'lebe-dealproduct' );
			...
			$product_item_class   = array( 'product-item', $atts['target'], 'famiau-wow-continuous lebe-wow fadeInUp' );
			...
			return apply_filters( 'Lebe_Shortcode_dealproduct', force_balance_tags( $html ), $atts, $content );
		}
	}
}