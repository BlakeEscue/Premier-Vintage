...
if (!class_exists('Lebe_Shortcode_Team')) {
    class Lebe_Shortcode_Team extends Lebe_Shortcode
    {
        /**
         * Shortcode name.
         *
        ...
        {
            $atts = function_exists('vc_map_get_attributes') ? vc_map_get_attributes('lebe_team', $atts) : $atts;
        ...
        public function output_html($atts, $content = null)
        {
            ...
            return apply_filters('lebe_toolkit_shortcode_team', $html, $atts, $content);
        }
    }
}