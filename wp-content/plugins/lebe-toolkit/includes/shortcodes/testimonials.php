...
if (!class_exists('Lebe_Shortcode_Testimonials')) {
    class Lebe_Shortcode_Testimonials extends Lebe_Shortcode
    {
        /**
         * Shortcode name.
         *
        ...
        {
            $atts = function_exists('vc_map_get_attributes') ? vc_map_get_attributes('lebe_testimonials', $atts) : $atts;
        ...
        public function output_html($atts, $content = null)
        {
            ...
            // Extract shortcode parameters.
            extract($atts);
            $css_class = array('lebe-testimonial');
            ...
            <div class="<?php echo esc_attr(implode(' ', $css_class)); ?>">
                <div class="testimonial-inner">
                    <?php if ($atts['image'] && ($atts['style'] == 'style-03' || $atts['style'] == 'style-04')): ?>
                        <div class="thumb">
                    ...
                    <?php endif; ?>
                    <?php if ($atts['rating'] && $atts['style'] == 'style-03') : ?>
                        <div class="rating <?php echo esc_attr($atts['rating']); ?>"><span></span></div>
                    <?php endif; ?>
                    <?php if ($atts['name']) : ?>
                        <h3 class="name">
            ...
            return apply_filters('lebe_toolkit_shortcode_testimonials', $html, $atts, $content);
        }
    }
}