...
if (!class_exists('Lebe_Shortcode_Instagram')) {

    class Lebe_Shortcode_Instagram extends Lebe_Shortcode
    {
        /**
         * Shortcode name.
         *
        ...
        {
            $atts = function_exists('vc_map_get_attributes') ? vc_map_get_attributes('lebe_instagram', $atts) : $atts;
        ...
        public function output_html($atts, $content = null)
        {
            ...
            // Extract shortcode parameters.
            extract($atts);
            $css_class = array('lebe-instagram-sc');
            ...
            <div class="<?php echo esc_attr(implode(' ', $css_class)); ?>">
                <div class="instagram-inner">
                    <?php if ($atts['style'] == 'style-01' || $atts['style'] == 'style-02' || $atts['style'] == 'style-04' || $atts['style'] == 'style-05'): ?>
                    ...
                    <?php
                    if (intval($id) === 0) {
                        esc_html_e('No user ID specified.', 'lebe');
                    }
                    ...
                    if ($id && $token) {
                        ...
                        if (!is_wp_error($response)) {
                            ...
                            if ($response_body->meta->code !== 200) {
                                echo '<p>' . esc_html__('User ID and access token do not match. Please check again.', 'lebe') . '</p>';
                            } else {
                    ...
                    <?php if (isset($items) && $items): ?>
                        <?php if ($atts['style'] == 'style-01' || $atts['style'] == 'style-04'):
                            $owl_settings = $this->generate_carousel_data_attributes('', $atts);
                            $owl_class[] = 'owl-carousel nav-center ' . $atts['nav_color'] . ' ' . $atts['dots_color'];
                            $i = 1; ?>
                                    ...
                                    <?php foreach ($items as $item): ?>
                                        <div class="item <?php echo $owl_rows_space;; ?>">
                                            <a target="_blank" href="<?php echo esc_url($item['link']) ?>">
                                                <?php echo lebe_toolkit_img_output($item); ?>
                                            </a>
                                            <div class="info-img">
                        ...
                        <?php elseif ($atts['style'] == 'style-05') :
		                    $grid_class   = array();
                            $grid_class[] = 'row auto-clear';
		                    $grid_item_class[] = $boostrap_rows_space;
		                    $grid_item_class[] = 'col-bg-' . $boostrap_bg_items;
		                    $grid_item_class[] = 'col-lg-' . $boostrap_lg_items;
		                    $grid_item_class[] = 'col-md-' . $boostrap_md_items;
		                    $grid_item_class[] = 'col-sm-' . $boostrap_sm_items;
		                    $grid_item_class[] = 'col-xs-' . $boostrap_xs_items;
		                    $grid_item_class[] = 'col-ts-' . $boostrap_ts_items;
                            ?>
                            <div class="<?php echo esc_attr(implode(' ', $grid_class)); ?> ">
                                <?php foreach ($items as $item): ?>
                                    <div class="<?php echo esc_attr( implode( ' ', $grid_item_class ) ); ?>">
                                        <div class="item">
                                            <a target="_blank" href="<?php echo esc_url($item['link']) ?>">
                                                <?php echo lebe_toolkit_img_output($item); ?>
                                            </a>
                        ...
                        <?php elseif ($atts['style'] == 'style-02') : ?>
                            <div class="item-table">
                                <div class="item-cell">
                                    <div class="item">
                                        <a target="_blank" href="<?php echo esc_url($items[0]['link']) ?>">
                                            <?php echo lebe_toolkit_img_output($items[0]); ?>
                                        </a>
                                        <div class="info-img">
                                            <span class="social-info"><i class="flaticon-comment"></i><?php echo esc_attr($items[0]['comments']); ?></span>
                                ...
                                <div class="item-cell">
                                    <div class="item">
                                        <a target="_blank" href="<?php echo esc_url($items[1]['link']) ?>">
                                            <?php echo lebe_toolkit_img_output($items[1]); ?>
                                        </a>
                                        <div class="info-img">
                                    ...
                                    <div class="item">
                                        <a target="_blank" href="<?php echo esc_url($items[2]['link']) ?>">
                                            <?php echo lebe_toolkit_img_output($items[2]); ?>
                                        </a>
                                        <div class="info-img">
                                             <span class="social-info"><i
                                ...
                                <div class="item-cell">
                                    <div class="item">
                                        <a target="_blank" href="<?php echo esc_url($items[3]['link']) ?>">
                                            <?php echo lebe_toolkit_img_output($items[3]); ?>
                                        </a>
                                        <div class="info-img">
                                            <span class="social-info"><i class="flaticon-comment"></i><?php echo esc_attr($items[3]['comments']); ?></span>
                                    ...
                                    <div class="item">
                                        <a target="_blank" href="<?php echo esc_url($items[4]['link']) ?>">
                                            <?php echo lebe_toolkit_img_output($items[4]); ?>
                                        </a>
                                        <div class="info-img">
                                            <span class="social-info"><i class="flaticon-comment"></i><?php echo esc_attr($items[4]['comments']); ?></span>
                                            <span class="social-info"><i class="flaticon-heart"></i><?php echo esc_attr($items[4]['likes']); ?>
                                                </span>
                                        </div>
                                    </div>
                                    <div class="item">
                                        <a target="_blank" href="<?php echo esc_url($items[5]['link']) ?>">
                                            <?php echo lebe_toolkit_img_output($items[5]); ?>
                                        </a>
                                        <div class="info-img">
                                             <span class="social-info"><i class="flaticon-comment"></i><?php echo esc_attr($items[5]['comments']); ?>
                                                 </span>
                                            <span class="social-info"><i class="flaticon-heart"></i><?php echo esc_attr($items[5]['likes']); ?>
                                                </span>
                                        </div>
                                    </div>
                                </div>
                                <div class="item-cell">
                                    <div class="item">
                                        <a target="_blank" href="<?php echo esc_url($items[6]['link']) ?>">
                                            <?php echo lebe_toolkit_img_output($items[6]); ?>
                                        </a>
                                        <div class="info-img">
                                            <span class="social-info"><i
                                                        class="flaticon-comment"></i><?php echo esc_attr($items[6]['comments']); ?></span>
                                            <span class="social-info"><i class="flaticon-heart"></i><?php echo esc_attr($items[6]['likes']); ?>
                                                </span>
                                        </div>
                                    </div>
                                    <div class="item">
                                        <a target="_blank" href="<?php echo esc_url($items[7]['link']) ?>">
                                            <?php echo lebe_toolkit_img_output($items[7]); ?>
                                        </a>
                                        <div class="info-img">
                                            <span class="social-info"><i
                                                        class="flaticon-comment"></i><?php echo esc_attr($items[7]['comments']); ?></span>
                                            <span class="social-info"><i class="flaticon-heart"></i><?php echo esc_attr($items[7]['likes']); ?>
                                                </span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        <?php elseif ($atts['style'] == 'style-03') : ?>
                            <div class="item-wrap">
                                <?php if ($atts['iconimage'] != ''): ?>
                                    <div class="icon">
                                        <?php if ($atts['iconimage'] == 'imagetype' && $atts['image']): ?>
            ...
            return apply_filters('lebe_toolkit_shortcode_instagram', force_balance_tags($html), $atts, $content);
        }
    }
}
