...
class Lebe_Mapper {
	 ...
	 * @var  string
	 */
	protected static $prefix = 'Lebe_Mapper_';
	...
	public static function initialize() {
		...
		Lebe_Mapper_Post_Type::initialize();

		// Initialize shortcode.
		Lebe_Mapper_Shortcode::initialize();
	...
	public static function autoload( $class_name ) {
		...
		$base = LEBE_TOOLKIT_PATH . '/includes/classes/lebe-mapper/includes/';
