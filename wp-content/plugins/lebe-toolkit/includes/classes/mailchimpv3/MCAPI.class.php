...
class MCAPI
{
	...
	private function show_error( $message )
	{
		...
		add_settings_error( 'ocolus-api', 'ocolus-api-error', $message, 'error' );
	...
	{
		$message .= '<br /><br />' . sprintf( '<a href="%s">' . __( 'Read more about common connectivity issues.', 'ocolus-toolkit' ) . '</a>', 'https://kb.mc4wp.com/solving-connectivity-issues/#utm_source=wp-plugin&utm_medium=mailchimp-for-wp&utm_campaign=settings-notice' );
	...
	public function call( $method, array $data = array() )
	{
		...
		$request_args   = array(
			...
			'sslverify' => apply_filters( 'ocolus_use_sslverify', true ),
		);
