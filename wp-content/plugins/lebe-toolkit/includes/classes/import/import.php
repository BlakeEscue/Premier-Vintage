...
if ( ! class_exists( 'LEBE_IMPORTER' ) ) {
	class LEBE_IMPORTER {
		...
		public function __construct() {
			...
			$registed_menu = array(
				'primary'     => esc_html__( 'Primary Menu', 'lebe-toolkit' ),
				'double-menu' => esc_html__( 'Double Menu', 'lebe-toolkit' ),
			);
			$menu_location = array(
			...
			$data_filter   = array(
				'data_demos'    => array(
					array(
						'name'           => esc_html__( 'Home Default', 'lebe-toolkit' ),
						'slug'           => 'home-default',
						'menus'          => $registed_menu,
						'homepage'       => 'Home Default',
						'blogpage'       => 'Blog',
						'preview'        => LEBE_IMPORTER_URI . '/data/previews/home-default.jpg',
						'demo_link'      => 'https://lebe.famithemes.com/home-default/',
						'menu_locations' => $menu_location,
						'theme_option'   => LEBE_IMPORTER_DIR . '/data/theme-options.txt',
						'content_path'   => LEBE_IMPORTER_DIR . '/data/content.xml',
						'widget_path'    => LEBE_IMPORTER_DIR . '/data/widgets.wie',
						'revslider_path' => LEBE_IMPORTER_DIR . '/data/revsliders/',
					),
					array(
						'name'           => esc_html__( 'Home Minimal', 'lebe-toolkit' ),
						'slug'           => 'home-minimal',
						'menus'          => $registed_menu,
						'homepage'       => 'Home Minimal',
						'blogpage'       => 'Blog',
						'preview'        => LEBE_IMPORTER_URI . '/data/previews/home-minimal.jpg',
						'demo_link'      => 'https://lebe.famithemes.com/home-minimal/',
						'menu_locations' => $menu_location,
						'theme_option'   => LEBE_IMPORTER_DIR . '/data/theme-options.txt',
						'content_path'   => LEBE_IMPORTER_DIR . '/data/content.xml',
						'widget_path'    => LEBE_IMPORTER_DIR . '/data/widgets.wie',
					...
					array(
						'name'           => esc_html__( 'Home Classic', 'lebe-toolkit' ),
						'slug'           => 'home-classic',
						'menus'          => $registed_menu,
						'homepage'       => 'Home Classic',
						'blogpage'       => 'Blog',
						'preview'        => LEBE_IMPORTER_URI . '/data/previews/home-classic.jpg',
						'demo_link'      => 'https://lebe.famithemes.com/home-classic/',
						'menu_locations' => $menu_location,
						'theme_option'   => LEBE_IMPORTER_DIR . '/data/theme-options.txt',
						'content_path'   => LEBE_IMPORTER_DIR . '/data/content.xml',
						'widget_path'    => LEBE_IMPORTER_DIR . '/data/widgets.wie',
					...
					array(
						'name'           => esc_html__( 'Home Collection', 'lebe-toolkit' ),
						'slug'           => 'home-collection',
						'menus'          => $registed_menu,
						'homepage'       => 'Home Collection',
						'blogpage'       => 'Blog',
						'preview'        => LEBE_IMPORTER_URI . '/data/previews/home-collection.jpg',
						'demo_link'      => 'https://lebe.famithemes.com/home-collection/',
						'menu_locations' => $menu_location,
						'theme_option'   => LEBE_IMPORTER_DIR . '/data/theme-options.txt',
						'content_path'   => LEBE_IMPORTER_DIR . '/data/content.xml',
						'widget_path'    => LEBE_IMPORTER_DIR . '/data/widgets.wie',
						'revslider_path' => LEBE_IMPORTER_DIR . '/data/revsliders/', // No slider but still import
					),
					array(
						'name'           => esc_html__( 'Home Categories', 'lebe-toolkit' ),
						'slug'           => 'home-categories',
						'menus'          => $registed_menu,
						'homepage'       => 'Home Categories',
						'blogpage'       => 'Blog',
						'preview'        => LEBE_IMPORTER_URI . '/data/previews/home-categories.jpg',
						'demo_link'      => 'https://lebe.famithemes.com/home-categories/',
						'menu_locations' => $menu_location,
						'theme_option'   => LEBE_IMPORTER_DIR . '/data/theme-options.txt',
						'content_path'   => LEBE_IMPORTER_DIR . '/data/content.xml',
						'widget_path'    => LEBE_IMPORTER_DIR . '/data/widgets.wie',
					...
					array(
						'name'           => esc_html__( 'Home Modern', 'lebe-toolkit' ),
						'slug'           => 'home-modern',
						'menus'          => $registed_menu,
						'homepage'       => 'Home Modern',
						'blogpage'       => 'Blog',
						'preview'        => LEBE_IMPORTER_URI . '/data/previews/home-modern.jpg',
						'demo_link'      => 'https://lebe.famithemes.com/home-modern/',
						'menu_locations' => $menu_location,
						'theme_option'   => LEBE_IMPORTER_DIR . '/data/theme-options.txt',
						'content_path'   => LEBE_IMPORTER_DIR . '/data/content.xml',
						'widget_path'    => LEBE_IMPORTER_DIR . '/data/widgets.wie',
					...
					array(
						'name'           => esc_html__( 'Home Stylish', 'lebe-toolkit' ),
						'slug'           => 'home-stylish',
						'menus'          => $registed_menu,
						'homepage'       => 'Home Stylish',
						'blogpage'       => 'Blog',
						'preview'        => LEBE_IMPORTER_URI . '/data/previews/home-stylish.jpg',
						'demo_link'      => 'https://lebe.famithemes.com/home-stylish/',
						'menu_locations' => $menu_location,
						'theme_option'   => LEBE_IMPORTER_DIR . '/data/theme-options.txt',
						'content_path'   => LEBE_IMPORTER_DIR . '/data/content.xml',
						'widget_path'    => LEBE_IMPORTER_DIR . '/data/widgets.wie',
					...
					array(
						'name'           => esc_html__( 'Home Bestseller', 'lebe-toolkit' ),
						'slug'           => 'home-bestseller',
						'menus'          => $registed_menu,
						'homepage'       => 'Home Bestseller',
						'blogpage'       => 'Blog',
						'preview'        => LEBE_IMPORTER_URI . '/data/previews/home-bestseller.jpg',
						'demo_link'      => 'https://lebe.famithemes.com/home-bestseller/',
						'menu_locations' => $menu_location,
						'theme_option'   => LEBE_IMPORTER_DIR . '/data/theme-options.txt',
						'content_path'   => LEBE_IMPORTER_DIR . '/data/content.xml',
						'widget_path'    => LEBE_IMPORTER_DIR . '/data/widgets.wie',
					...
					array(
						'name'           => esc_html__( 'Home Instagram', 'lebe-toolkit' ),
						'slug'           => 'home-instagram',
						'menus'          => $registed_menu,
						'homepage'       => 'Home Instagram',
						'blogpage'       => 'Blog',
						'preview'        => LEBE_IMPORTER_URI . '/data/previews/home-instagram.jpg',
						'demo_link'      => 'https://lebe.famithemes.com/home-instagram/',
						'menu_locations' => $menu_location,
						'theme_option'   => LEBE_IMPORTER_DIR . '/data/theme-options.txt',
						'content_path'   => LEBE_IMPORTER_DIR . '/data/content.xml',
						'widget_path'    => LEBE_IMPORTER_DIR . '/data/widgets.wie',
					...
					array(
						'name'           => esc_html__( 'Home Barber', 'lebe-toolkit' ),
						'slug'           => 'home-barber',
						'menus'          => $registed_menu,
						'homepage'       => 'Home Barber',
						'blogpage'       => 'Blog',
						'preview'        => LEBE_IMPORTER_URI . '/data/previews/home-barber.jpg',
						'demo_link'      => 'https://lebe-barber.famithemes.com/',
						'menu_locations' => $menu_location,
						'theme_option'   => LEBE_IMPORTER_DIR . '/data/theme-options-barber.txt',
						'content_path'   => LEBE_IMPORTER_DIR . '/data/content-barber.xml',
						'widget_path'    => LEBE_IMPORTER_DIR . '/data/widgets-barber.wie',
						'revslider_path' => LEBE_IMPORTER_DIR . '/data/revsliders/'
					),
					array(
						'name'           => esc_html__( 'Home Electronic', 'lebe-toolkit' ),
						'slug'           => 'home-electronic',
						'menus'          => $registed_menu,
						'homepage'       => 'Home Electronic',
						'blogpage'       => 'Blog',
						'preview'        => LEBE_IMPORTER_URI . '/data/previews/home-electronic.jpg',
						'demo_link'      => 'https://lebe-electronic.famithemes.com/',
						'menu_locations' => $menu_location,
						'theme_option'   => LEBE_IMPORTER_DIR . '/data/theme-options-electronic.txt',
						'content_path'   => LEBE_IMPORTER_DIR . '/data/content-electronic.xml',
						'widget_path'    => LEBE_IMPORTER_DIR . '/data/widgets-electronic.wie',
						'revslider_path' => LEBE_IMPORTER_DIR . '/data/revsliders/'
					),
					array(
						'name'           => esc_html__( 'Home Furniture', 'lebe-toolkit' ),
						'slug'           => 'home-furniture',
						'menus'          => $registed_menu,
						'homepage'       => 'Home Furniture',
						'blogpage'       => 'Blog',
						'preview'        => LEBE_IMPORTER_URI . '/data/previews/home-furniture.jpg',
						'demo_link'      => 'https://lebe-furniture.famithemes.com/',
						'menu_locations' => $menu_location,
						'theme_option'   => LEBE_IMPORTER_DIR . '/data/theme-options-furniture.txt',
						'content_path'   => LEBE_IMPORTER_DIR . '/data/content-furniture.xml',
						'widget_path'    => LEBE_IMPORTER_DIR . '/data/widgets-furniture.wie',
						'revslider_path' => LEBE_IMPORTER_DIR . '/data/revsliders/'
					),
				),
				'item_import'   => array(
					...
					'fami_delete_hello_world'     => 'Delete "Hello world!" Post',
				),
				'woo_pages'     => array(
			...
			$import_data   = apply_filters( 'lebe_data_import', $data_filter );
			// SET DATA DEMOS
			...
			if ( $enable_import ) {
				...
				add_action( 'wp_ajax_fami_delete_hello_world', array( $this, 'delete_hello_world' ) );
			}
		}
		...
		public function define_constants() {
			$this->define( 'LEBE_IMPORTER_DIR', LEBE_TOOLKIT_PATH . '/includes/classes/import' );
			$this->define( 'LEBE_IMPORTER_URI', LEBE_TOOLKIT_URL . '/includes/classes/import' );
		}
		...
		public function register_scripts( $hook_suffix ) {
			if ( $hook_suffix == 'toplevel_page_lebe_menu' ) {
				wp_enqueue_style( 'thickbox' );
				wp_enqueue_style( 'fami-importer-style', LEBE_IMPORTER_URI . '/assets/circle.css' );
				wp_enqueue_style( 'fami-importer-circle', LEBE_IMPORTER_URI . '/assets/import.css' );
				wp_enqueue_script( 'thickbox' );
				wp_enqueue_script( 'fami-importer-script', LEBE_IMPORTER_URI . '/assets/import.js', array( 'jquery' ), false );
			}
		}
            ...
            <div class="fami-importer-wrapper">
                ...
                <div class="note">
                    ...
                    <p>Please ensure you have already installed and
                        activated Lebe Toolkit, WooCommerce, WPBakery Page Builder and Revolution Slider plugins.</p>
		...
		public function before_content_import() {
			if ( class_exists( 'WooCommerce' ) ) {
				...
				if ( current_user_can( 'administrator' ) ) {
					...
					$attributes = apply_filters( 'lebe_import_wooCommerce_attributes', $attributes );
		...
		public function import_full_content() {
			...
			$already_imported_full_data = get_option( 'lebe_already_imported_full_data', 'no' ) == 'yes';
			...
			$this->import_content();
			update_option( 'lebe_already_imported_full_data', 'yes' );
		...
		public function import_page_content() {
			$already_imported_page = get_option( 'lebe_already_imported_page', 'no' ) == 'yes';
			...
			$this->ajax_options_posttype = array( 'page' );
			$this->import_content();
			update_option( 'lebe_already_imported_page', 'yes' );
			wp_die();
		}
		
		public function import_post_content() {
			$already_imported_post = get_option( 'lebe_already_imported_post', 'no' ) == 'yes';
			...
			$this->import_content();
			update_option( 'lebe_already_imported_post', 'yes' );
			wp_die();
		}
		
		public function import_attachments() {
			$already_imported_attachment = get_option( 'lebe_already_imported_attachment', 'no' ) == 'yes';
			...
			$this->ajax_attachments      = true;
			$this->import_content();
			update_option( 'lebe_already_imported_attachment', 'yes' );
			wp_die();
		}
		
		public function import_product_content() {
			$already_imported_product = get_option( 'lebe_already_imported_product', 'no' ) == 'yes';
			...
			update_option( 'lebe_already_imported_product', 'yes' );
			wp_die();
		}
		...
		public function import_menu() {
			...
			$already_imported_menu = get_option( 'lebe_already_imported_menu', 'no' ) == 'yes';
			if ( $already_imported_menu ) {
				wp_die();
			}
			$optionid               = isset( $_POST['optionid'] ) ? $_POST['optionid'] : '';
			$this->ajax_optionid    = $optionid;
			$this->ajax_menu_import = 1;
			$this->import_content();
			update_option( 'lebe_already_imported_menu', 'yes' );
			
			// Fix nav menu item links
			if ( $optionid != '' ) {
				$demo = isset( $this->data_demos[ $optionid ] ) ? $this->data_demos[ $optionid ] : array();
				if ( ! empty( $demo ) ) {
					$org_domain      = 'lebe.famithemes.com';
					$cur_site_url    = get_site_url();
					$parse           = parse_url( $cur_site_url );
					$cur_site_domain = $parse['host'];
					
					// Check org domain
					if ( $demo['slug'] == 'home-furniture' ) {
						$org_domain = 'lebe-furniture.famithemes.com';
					}
					if ( $demo['slug'] == 'home-barber' ) {
						$org_domain = 'lebe-barber.famithemes.com';
					}
					if ( $demo['slug'] == 'home-electronic' ) {
						$org_domain = 'lebe-electronic.famithemes.com';
					}
					
					// $sql = "UPDATE urls SET url = REPLACE(url, 'domain1.com/images/', 'domain2.com/otherfolder/')";
					
					$sql = $wpdb->prepare( "UPDATE {$wpdb->prefix}posts SET post_content = REPLACE(post_content, %s, %s), guid = REPLACE(guid, %s, %s)", $org_domain, $cur_site_domain, $org_domain, $cur_site_domain );
					$wpdb->query( $sql );
		...
		public function import_widget() {
			...
			$already_imported_widgets = get_option( 'lebe_already_imported_widgets', 'no' ) == 'yes';
			...
			update_option( 'lebe_already_imported_widgets', 'yes' );
			wp_die();
		}
		...
		public function import_revslider() {
			...
			// Don't import widgets twice
			$already_imported_revslider = get_option( 'lebe_already_imported_revslider', 'no' ) == 'yes';
			...
			update_option( 'lebe_already_imported_revslider', 'yes' );
			wp_die();
		}
		...
		public function update_prdctfltr_settings() {
			...
			if ( class_exists( 'PrdctfltrInit' ) ) {
				$already_imported_prdctfltr_settings = get_option( 'lebe_already_imported_prdctfltr_settings', 'no' ) == 'yes';
				...
				update_option( 'lebe_already_imported_prdctfltr_settings', 'yes' );
			}
		}
		...
		public function update_sales_popup_settings() {
			...
			if ( class_exists( 'famiSalesPopup' ) ) {
				// Import Sales Popup
				$already_imported_sales_popup = get_option( 'lebe_already_imported_sales_popup', 'no' ) == 'yes';
				if ( ! $already_imported_sales_popup ) {
					return;
				}
				
				// LEBE_IMPORTER_URI
				if ( file_exists( LEBE_IMPORTER_DIR . 'data-sample/sale-popup-data.txt' ) ) {
					$sales_popup_response_data = wp_remote_get( LEBE_IMPORTER_URI . 'data-sample/sale-popup-data.txt' );
					...
					update_option( 'lebe_already_imported_sales_popup', 'yes' );
				}
			}
		}
	}
