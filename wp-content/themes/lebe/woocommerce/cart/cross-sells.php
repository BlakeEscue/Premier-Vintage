...
$lebe_enable_cross_sell = lebe_get_option( 'enable_cross_sell', 'yes' );
if ( $lebe_enable_cross_sell == 'no' ) {
	return;
}

$classes[]      = 'product-item style-1';

$woo_crosssell_ls_items = lebe_get_option( 'lebe_woo_crosssell_ls_items', 4 );
$woo_crosssell_lg_items = lebe_get_option( 'lebe_woo_crosssell_lg_items', 4 );
$woo_crosssell_md_items = lebe_get_option( 'lebe_woo_crosssell_md_items', 3 );
$woo_crosssell_sm_items = lebe_get_option( 'lebe_woo_crosssell_sm_items', 2 );
$woo_crosssell_xs_items = lebe_get_option( 'lebe_woo_crosssell_xs_items', 2 );
$woo_crosssell_ts_items = lebe_get_option( 'lebe_woo_crosssell_ts_items', 1 );
...
$woo_cross_sell_title = lebe_get_option( 'lebe_cross_sells_products_title', 'You may be interested in...' );
