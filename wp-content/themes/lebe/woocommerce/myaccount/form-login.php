...
<div class="customer-form" id="<?php echo esc_attr( $customer_login_id ); ?>">
    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane fade in active" id="<?php echo esc_attr( $login_id ); ?>"
            ...
            <p class="des-login"><?php esc_html_e( 'Create an account to expedite future checkouts, track order history & receive emails, discounts, & special offers', 'lebe' ); ?></p>
            <div class="login-form block-form">
                ...
                <form method="post" class="login">
                    ...
                    <p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
                        <input placeholder="<?php esc_attr_e( 'Username', 'lebe' ); ?> " type="text"
                    ...
                    <p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
                        <input placeholder="<?php esc_attr_e( 'Password', 'lebe' ); ?>"
                    ...
                    <p class="form-row">
                        ...
                        <label for="<?php echo esc_attr( $rememberme_id ); ?>" class="rememberme">
                            <input class="woocommerce-Input woocommerce-Input--checkbox" name="rememberme"
                                   ...
                                   value="forever"/>
                            <span><?php esc_html_e( 'Remember me', 'lebe' ); ?></span>
                        </label>
                        <a class="woocommerce-LostPassword lost_password"
                           href="<?php echo esc_url( wp_lostpassword_url() ); ?>"><?php esc_html_e( 'Lost your password?', 'lebe' ); ?></a>

                        <input type="submit" class="woocommerce-Button button" name="login"
                               value="<?php esc_attr_e( 'Login', 'lebe' ); ?>"/>
                    </p>
					
					<?php do_action( 'lebe_action_social_login' ); ?>
        ...
        <div role="tabpanel" class="tab-pane fade" id="<?php echo esc_attr( $register_id ); ?>"
            ...
            <div class="login-icon">
                ...
                <p class="des-res"><?php esc_html_e( 'Register', 'lebe' ); ?></p>
            </div>
            <div class="register-form block-form">
                ...
                <form method="post" class="register">
                    ...
                    <p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
                        <input placeholder="<?php esc_attr_e( 'Email address', 'lebe' ); ?>" type="email"
					...
					<?php if ( 'no' === get_option( 'woocommerce_registration_generate_password' ) ) : ?>
                        ...
                        <p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
                            <input placeholder="<?php esc_attr_e( 'Password', 'lebe' ); ?>" type="password"
                    ...
                    <div style="<?php echo( ( is_rtl() ) ? 'right' : 'left' ); ?>: -999em; position: absolute;"><label
                                for="<?php echo esc_attr( $trap_id ); ?>"><?php esc_html_e( 'Anti-spam', 'lebe' ); ?></label><input
                                type="text"
                                name="email_2"
                    ...
                    <p class="woocomerce-FormRow form-row">
                        ...
                        <input type="submit" class="woocommerce-Button button" name="register"
                               value="<?php esc_attr_e( 'Register', 'lebe' ); ?>"/>
                    </p>
    ...
    <div class="spec"><span><?php esc_html_e( 'Or', 'lebe' ); ?></span></div>
        ...
        <li role="presentation" class="active">
            <a href="#<?php echo esc_attr( $login_id ); ?>" role="tab"
               ...
               aria-controls="<?php echo esc_attr( $login_id ); ?>">
				<?php esc_html_e( 'Back to login', 'lebe' ); ?>
            </a>
        </li>
        <li role="presentation">
            <a href="#<?php echo esc_attr( $register_id ); ?>" id="<?php echo esc_attr( $register_tab_id ); ?>"
               role="tab" data-toggle="tab" aria-controls="<?php echo esc_attr( $register_id ); ?>">
				<?php esc_html_e( 'Create an account', 'lebe' ); ?>
            </a>
        </li>
    </ul>
