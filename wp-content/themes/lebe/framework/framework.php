...
?>
<?php
if ( ! class_exists( 'Lebe_framework' ) ) {
	class Lebe_framework {
		/**
		...
		public function enqueue_scripts() {
            wp_enqueue_style( 'flaticon', get_theme_file_uri( '/assets/fonts/flaticon.css' ), array(), '1.0' );
			wp_enqueue_style( 'lebe-custom-admin-css', get_theme_file_uri( '/framework/assets/css/admin.css' ), array( 'cs-framework' ), '1.0' );
			wp_enqueue_script( 'lebe-custom-admin-js', get_theme_file_uri( '/framework/assets/js/admin.js' ), array(), '1.0' );
		}
