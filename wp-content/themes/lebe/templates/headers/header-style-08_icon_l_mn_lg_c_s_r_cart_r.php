<?php
/*
 Name:  Header Style8 Icon Left - Menu, Logo Center - Cart Right
 */
...
?>
<header id="header"
        class="site-header header style-08 header-lg_l-mn_c-ic_r lg_l mn_c ic_r <?php echo esc_attr( $header_class ); ?>">
