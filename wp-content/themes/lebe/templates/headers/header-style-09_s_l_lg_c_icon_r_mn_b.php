<?php
/*
 Name:  Header style9 Search Left - Logo,menu center - Icons Right
 */
...
?>
<header id="header"
        class="site-header header style-09 header-lg_c-mn_l-ic_r lg_c mn_l ic_r <?php echo esc_attr( $header_class ); ?>">
