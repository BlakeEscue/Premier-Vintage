<?php
/*
 Name:  Header Style3 Logo Left, Menu left - Search, Icons Right
 */
...
?>
<header id="header"
        class="site-header header style-03 header-mn_l-lg_cl-ic_r mn_l lg_l ic_r <?php echo esc_attr( $header_class ); ?>">
