<?php
/*
 Name:  Header Style5 Search Left - Logo Center - Icons Right - Menu Right
 */
...
?>
<header id="header"
        class="site-header header style-05 header-s_l-lg_c-ic_r s_l lg_c mm_r ic_r <?php echo esc_attr( $header_class ); ?>">
                ...
                <div class="header-position">
                    <div class="header-container container">
                        <div class="header-menu horizon-menu">
                            <nav class="main-navigation">
                                <div class="main-menu">
                                    ...
                                    wp_nav_menu( array(
                                        ...
                                        'container_class' => '',
                                        'container_id'    => '',
                                        'menu_class'      => 'double-menu clone-main-menu lebe-nav main-menu',
                            ...
                            <span class="close-menu"><?php echo esc_html__('close', 'lebe') ?></span>
                        </div>
