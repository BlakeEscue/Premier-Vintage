<?php
/*
 Name:  Header style6 Search Left - Logo,menu center - Icons Right
 */
...
?>
<header id="header"
        class="site-header header style-06 header-lg_l-mn_l-ic_r lg_l mn_l ic_r <?php echo esc_attr( $header_class ); ?>">
