<?php
/*
 Name:  Header style7 Menu Left - Icon Left - Logo Center - Icons Right
 */
...
?>
<header id="header"
        class="site-header header style-07 header-mn_l-acl_lg-ic_r ac_l lg_c mn_l ic_r <?php echo esc_attr( $header_class ); ?>">
