...
<div class="lebe-minicart">
    ...
    <span class="mini-cart-icon">
        ...
        <span class="minicart-number"><?php printf( esc_html__( '%1$s', 'lebe' ), WC()->cart->cart_contents_count ); ?></span>
    </span>
	<?php if ( ! WC()->cart->is_empty() ) : ?>
        <div class="minicart-content">
            <div class="minicart-content-inner">
                <h3 class="minicart-title">
					<?php echo esc_html__( 'Your Cart', 'lebe' ); ?>
                </h3>
                <span class="minicart-number-items">
                    <?php printf( esc_html__( '%1$s', 'lebe' ), WC()->cart->cart_contents_count ); ?>
                </span>
                                ...
                                <li class="product-cart">
                                    ...
                                    <div class="product-detail">
                                        ...
                                        <div class="product-detail-info">
                                            <span class="product-quantity"><?php printf( esc_html__( 'QTY : %1$s', 'lebe' ), $cart_item['quantity'] ); ?></span>
                ...
                <div class="subtotal">
                    <span class="total-title"><?php echo esc_html__( 'Total: ', 'lebe' ); ?></span>
                ...
                <div class="actions">
                    <a class="button button-viewcart" href="<?php echo esc_url( wc_get_cart_url() ); ?>">
                        <span><?php echo esc_html__( 'View Cart', 'lebe' ); ?></span>
                    </a>
                    <a href="<?php echo esc_url( wc_get_checkout_url() ); ?>"
                       class="button button-checkout"><span><?php echo esc_html__( 'Checkout', 'lebe' ); ?></span></a>
                </div>
            </div>
        </div>
	<?php else : ?>
            ...
            <div class="minicart-content-inner">
                ...
                <div class="minicart-list-items">
                    <div class="empty-wrap">
                        <div class="empty-title"><?php esc_html_e( 'No products in the cart.', 'lebe' ); ?></div>
                        <a href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>"
                           class="to-cart"><?php esc_html_e( 'Start shopping', 'lebe' ); ?></a>
                    </div>
                </div>
                <div class="des-cart"><a
                            href="<?php echo esc_url( get_permalink( get_option( 'wp_page_for_privacy_policy' ) ) ); ?>"><?php esc_html_e( 'Our Shipping & Return Policy', 'lebe' ); ?></a></div>
            </div>
        </div>
	<?php endif; ?>
</div>
